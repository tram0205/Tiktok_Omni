    ...
    public static class ShowcaseVoicePresetCatalog
    {
        ...
        private static IReadOnlyList<ShowcaseVoicePresetDefinition> BuildAll()
        {
            ...
            return new List<ShowcaseVoicePresetDefinition>
            {
                ...
                P("female_general_young", "Nữ — trẻ (phát âm chung)", "vi_VN-vais1000-medium.onnx", vais, 1.02f, 0.66f, 0.76f, "calm"),
                P("female_general_mature", "Nữ — trung niên (phát âm chung)", "vi_VN-vais1000-medium.onnx", vais, 1.08f, 0.55f, 0.72f, "calm"),
                ...
                P("male_general_young", "Nam — trẻ (phát âm chung)", "vi_VN-vivos-x_low.onnx", vivos, 0.96f, 0.63f, 0.74f, "intense"),
